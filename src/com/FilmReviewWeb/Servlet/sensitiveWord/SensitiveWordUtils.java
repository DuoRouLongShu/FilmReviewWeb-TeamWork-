package com.FilmReviewWeb.Servlet.sensitiveWord;
/**
 * 敏感词处理工具类
 *
 * @author HTwo2O
...
public class SensitiveWordUtils {
    public static String filePath = SensitiveWordUtils.class.getClassLoader().getResource("sensitiveword.txt").getPath();
    ...
    static {
        SensitiveWordUtils.words = readTxtByLine(filePath);
        addBadWordToHashMap(SensitiveWordUtils.words);
    }
